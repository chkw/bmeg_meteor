...
var generateQuantiles = function() {
    var data = {};

    var a = 20;
    var b = a / 20;

    data.low = (a * Math.random()) - b;
    data.q1 = data.low;
    data.median = data.low;
    data.q3 = data.low;
    data.high = data.low;

    while (data.q1 <= data.low) {
        data.q1 = (a * Math.random()) - b;
    }
    while (data.median <= data.q1) {
        data.median = (a * Math.random()) - b;
    }
    while (data.q3 <= data.median) {
        data.q3 = (a * Math.random()) - b;
    }
    while (data.high <= data.q3) {
        data.high = (a * Math.random()) - b;
    }
    return data;
};
...
Template.testTemplate.events({
    ...
    "click button#clearBoxPlot": function(event, instance) {
        console.log("clearBoxPlot");
        clearDiv("testBoxPlot");
    },
    "click button#createBoxPlot": function(event, instance) {
        console.log("createBoxPlot");
        createBoxPlot("testBoxPlot", [generateQuantiles(), generateQuantiles()], "drug " + Math.random().toString(36).substring(7));
    }
});
